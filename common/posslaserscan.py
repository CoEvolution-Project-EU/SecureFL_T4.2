...
class LaserScan:
    ...
    def reset(self):
        ...
        self.tags = np.full((self.proj_H * self.proj_W), False, dtype=bool)
    ...
    def open_scan(self, filename, tagname):
        ...
        tags = np.fromfile(tagname, dtype=bool)
...
class SemLaserScan(LaserScan):
    ...
    def __init__(
        ...
        super(SemLaserScan, self).__init__(
            project, H, W, fov_up, fov_down, DA=DA, flip_sign=flip_sign, rot=rot, drop_points=drop_points
        )
        self.reset()
