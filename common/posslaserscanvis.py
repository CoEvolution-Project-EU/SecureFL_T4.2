...
class LaserScanVis:
    ...
    def __init__(self, scan, scan_names, tag_names, label_names, offset=0, semantics=True, instances=False):
        self.scan = scan
    ...
    def update_scan(self):
        ...
        self.scan_vis.set_data(
            self.scan.points, face_color=viridis_colors[..., ::-1], edge_color=viridis_colors[..., ::-1], size=1
        )
